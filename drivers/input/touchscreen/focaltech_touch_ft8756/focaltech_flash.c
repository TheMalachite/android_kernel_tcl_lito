...
//begin add by xiongbo.huang for Irvine Device Info on 20200810
#ifdef CONFIG_TCT_DEVICEINFO
extern char ctp_module_name[256];
#endif
//end add by xiongbo.huang for Irvine Device Info on 20200810
...
//begin add by xiongbo.huang for Irvine Device Info on 20200810
    ...
    //begin add by kun.zheng for  task 10597975 irvine R  compile error on 2020/02/01
    //snprintf(ctp_module_name, PAGE_SIZE, "FT8756:TDT:0x%x:AUC0680105C1",fwver);
    sprintf(ctp_module_name, "FT8756:TDT:0x%x:AUC0680105C1",fwver);
    //end add by kun.zheng for  task 10597975 irvine R  compile error on 2020/02/01
#endif
//end add by xiongbo.huang for Irvine Device Info on 20200810
}
