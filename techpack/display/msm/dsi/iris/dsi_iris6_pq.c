...
static u32 iris_camera1[][12] = {
	{0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14}, //LCE_AHECLIP_DARK_UPPER
	{0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64}, //LCE_AHECLIP_BRIGHT_UPPE
	{0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40}, //LCE_AHECLIP_MID_UPPER
	{0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200},//LCE_GAMMAUPPER_DARK
	{0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a}, //LCE_GAMMAGAIN_DARK
	{0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e},//SCURVE_LOW
	{0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118},//SCURVE_HIGH
	{0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8},//SCURVE_MID
	{0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01}, //DETAIL_ADAPTIVELUMA_EN
	{0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40}, //DETAIL_GAIN0
	{0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60}, //DETAIL_GAIN1
	{0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80}, //DETAIL_GAIN2
	{0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80}, //DETAIL_GAIN3
	{0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80}, //DETAIL_GAIN4
	{0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01}, //DETAIL_FLESHSMOOTH_EN
	{0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9}, //DETAIL_FLESHSMOOTH_GAIN
	{0xc8,	0xc8,  0xc8,  0xc8,  0xe6,  0xe6,  0xfa,  0xfa,  0xfa,	0xc8,  0xc8,  0xfa}, //PK_GAIN_BPF
};

static u32 iris_camera2[][11] = {
	{0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14,  0x14}, //LCE_AHECLIP_DARK_UPPER
	{0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64,  0x64}, //LCE_AHECLIP_BRIGHT_UPPE
	{0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40}, //LCE_AHECLIP_MID_UPPER
	{0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200, 0x200},//LCE_GAMMAUPPER_DARK
	{0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a,  0x5a}, //LCE_GAMMAGAIN_DARK
	{0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e, 0x10e},//SCURVE_LOW
	{0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118, 0x118},//SCURVE_HIGH
	{0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8, 0x3e8},//SCURVE_MID
	{0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01}, //DETAIL_ADAPTIVELUMA_EN
	{0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40,  0x40}, //DETAIL_GAIN0
	{0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60,  0x60}, //DETAIL_GAIN1
	{0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80}, //DETAIL_GAIN2
	{0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80}, //DETAIL_GAIN3
	{0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80,  0x80}, //DETAIL_GAIN4
	{0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01,  0x01}, //DETAIL_FLESHSMOOTH_EN
	{0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9,  0xb9}, //DETAIL_FLESHSMOOTH_GAIN
	{0xfa,	0xc8,  0xfa,  0xfa,  0x118, 0x118, 0xc8,  0xfa,  0xfa,	0xa0,  0xc8}, //PK_GAIN_BPF
};
...
static int iris_end_dpp(bool bcommit)
{
	...
	if (!iris_skip_dma) {
#ifdef CONFIG_PXLW_IRIS6_TWO_MCF
		len = iris_init_update_ipopt_t(IRIS_IP_DMA, 0xe3, 0xe3, 1);
		iris_init_update_ipopt_t(IRIS_IP_DPP, 0x90, 0x90, 0);
#else
...
void iris_cm_color_gamut_set(u32 level, bool bcommit)
{
	...
	bool apl = 0;
#ifndef CONFIG_PXLW_IRIS6_TWO_MCF
	uint32_t lut3d_interp1;
#endif
...
#ifdef CONFIG_PXLW_IRIS6_TWO_MCF
	IRIS_LOGI("aplstauts: 0x%x, gamm opt: 0x%x, gammactrl= 0x%x", aplstatus_value, gammalevel, gammactrl);
#else
...
void iris_hdr_enhance_set(bool enable, bool update)
{
	int len;
	uint32_t  *payload = NULL;
	...
	if (update)
		len = iris_start_hdr();
	if (enable == true) {
		payload = iris_get_ipopt_payload_data(IRIS_IP_SDR2HDR, 0x02, 3);
		payload[0] = payload[0] & (~0x00000248);
		iris_set_ipopt_payload_data(IRIS_IP_SDR2HDR, 0x02, 3, payload[0]);

		iris_set_ipopt_payload_data(IRIS_IP_SDR2HDR, 0xb2, 5, 0x0014a118);
	} else {
		payload = iris_get_ipopt_payload_data(IRIS_IP_SDR2HDR, 0x02, 3);
		payload[0] = payload[0] | 0x00000248;
		iris_set_ipopt_payload_data(IRIS_IP_SDR2HDR, 0x02, 3, payload[0]);

		iris_set_ipopt_payload_data(IRIS_IP_SDR2HDR, 0xb2, 5, 0x00100100);
	}
	len = iris_init_update_ipopt_t( IRIS_IP_SDR2HDR, 0x02, 0x02, 0x01);
	len = iris_init_update_ipopt_t( IRIS_IP_SDR2HDR, 0xb2, 0xb2, 0x01);
	if (update)
		len = iris_end_hdr(true);

	IRIS_LOGE("hdr enhance =%d", enable);
}
...
void iris_sdr2hdr_level_set(u32 level, bool bcommit)
{
	...
	if (level != HDR10PLUS)
		iris_hdr_enhance_set(false, false);
...
#ifdef CONFIG_PXLW_IRIS6_TWO_MCF
	len = iris_init_update_ipopt_t(IRIS_IP_DMA, 0xe3, 0xe3, 1);
	len = iris_init_update_ipopt_t(IRIS_IP_DPP, 0x90, 0x90, 0);
#else
	len = iris_init_update_ipopt_t(IRIS_IP_DMA, 0xe3, 0xe3, 0);
#endif
	iris_update_pq_opt(true);
	/*exit sdr2hdr would force update*/
	if (pqlt_cur_setting->pq_setting.sdr2hdr == 0) {
		iris_ocp_write_val(0xf11d1100, 0x00000003);
	}
...
#ifdef CONFIG_PXLW_IRIS6_TWO_MCF
#define GAIN_MAX (0x7fff)
#define LOW_BACKLVL  (100)
#define RATIO_SHIFT (20)

void iris_3dlut_interpolation_adjust(u32 bl_lvl, bool bcommit)
{
	u32 lutgain = 0;
	...
	if (bl_lvl <= LOW_BACKLVL)
		lutgain = 0;
	else if (bl_lvl <= panel->bl_config.bl_max_level)
		lutgain = (u32)(ratio / panel->bl_config.bl_max_level);

	IRIS_LOGD("bl_lvl: %d, lutgain: 0x%x", bl_lvl, lutgain);

	iris_dpp_3dlut_gain(lutgain, bcommit);
}
#endif
...
int iris_update_backlight(u32 bl_lvl)
{
...
#ifdef CONFIG_PXLW_IRIS6_TWO_MCF
		iris_3dlut_interpolation_adjust(bl_lvl, true);
#endif
	} else
#ifdef CONFIG_TCT_LITO_CHICAGO
		rc = mipi_dsi_dcs_set_display_brightness_chicago(dsi, bl_lvl, 0);
#else
	...
	if (panel->bl_config.bl_inverted_dbv)
		bl_lvl = (((bl_lvl & 0xff) << 8) | (bl_lvl >> 8));
#ifdef CONFIG_PXLW_IRIS6_TWO_MCF
	IRIS_LOGD("bl_max_level: %d, bl_lvl: %d\n", panel->bl_config.bl_max_level, bl_lvl);
#endif
...
void iris_sdr2hdr_camera(u32 value)
{
	uint32_t  *payload = NULL;
	u32 lce_option = 0x1d;
	u32 scurve_option = 0xbd;
	u32 de_option = 0xcd;
	u32 level;

	if (value < 12) {
		payload = iris_get_ipopt_payload_data(IRIS_IP_SDR2HDR, lce_option, 11);
		payload[0] = (payload[0] & 0x000fffff) | (iris_camera1[0][value] << 20);
		payload[1] = (payload[1] & 0x000fffff) | (iris_camera1[1][value] << 20);
		payload[2] = (payload[2] & 0x000fffff) | (iris_camera1[2][value] << 20);
		payload[8] = iris_camera1[3][value];
		payload[9] = (payload[9] & 0xff00ffff) | (iris_camera1[4][value] << 16);

		payload = iris_get_ipopt_payload_data(IRIS_IP_SDR2HDR, scurve_option, 5);
		payload[0] = iris_camera1[5][value] + (iris_camera1[6][value] << 12);
		payload[1] = iris_camera1[7][value];

		payload = iris_get_ipopt_payload_data(IRIS_IP_SDR2HDR, de_option, 2);
		payload[0] = (payload[0] & 0xfffbffff) | (iris_camera1[8][value] << 18);
		payload[1] = iris_camera1[9][value] + (iris_camera1[10][value] << 8)
			+ (iris_camera1[11][value] << 16);
		payload[2] = iris_camera1[12][value] + (iris_camera1[13][value] << 8);
		payload[17] = (payload[17] & 0xf801ffff) + (iris_camera1[14][value] << 17)
			+ (iris_camera1[15][value] << 18);
		payload[15] = (payload[15] & 0xffc007ff) | (iris_camera1[16][value] << 11);
	} else {
		level = value - 12;
		payload = iris_get_ipopt_payload_data(IRIS_IP_SDR2HDR, lce_option, 11);
		payload[0] = (payload[0] & 0x000fffff) | (iris_camera2[0][level] << 20);
		payload[1] = (payload[1] & 0x000fffff) | (iris_camera2[1][level] << 20);
		payload[2] = (payload[2] & 0x000fffff) | (iris_camera2[2][level] << 20);
		payload[8] = iris_camera2[3][level];
		payload[9] = (payload[9] & 0xff00ffff) | (iris_camera2[4][level] << 16);

		payload = iris_get_ipopt_payload_data(IRIS_IP_SDR2HDR, scurve_option, 5);
		payload[0] = iris_camera2[5][level] + (iris_camera2[6][level] << 12);
		payload[1] = iris_camera2[7][level];

		payload = iris_get_ipopt_payload_data(IRIS_IP_SDR2HDR, de_option, 2);
		payload[0] = (payload[0] & 0xfffbffff) | (iris_camera2[8][level] << 18);
		payload[1] = iris_camera2[9][level] + (iris_camera2[10][level] << 8)
			+ (iris_camera2[11][level] << 16);
		payload[2] = iris_camera2[12][level] + (iris_camera2[13][level] << 8);
		payload[17] = (payload[17] & 0xf801ffff) + (iris_camera2[14][level] << 17)
			+ (iris_camera2[15][level] << 18);
		payload[15] = (payload[15] & 0xffc007ff) | (iris_camera2[16][level] << 11);
	}
	IRIS_LOGD("camera_level = %d", value);
}
