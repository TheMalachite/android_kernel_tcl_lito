...
extern int vm_direct_swappiness;
...
{
	int swappiness = current_is_kswapd() ?
		vm_swappiness : vm_direct_swappiness;
...
{
	return current_is_kswapd() ? vm_swappiness : vm_direct_swappiness;
}
#endif
